...
builder.Services.AddAuthentication("MyCookieAuth")
    .AddCookie("MyCookieAuth", options =>
    {
        ...
        options.LoginPath = "/api/libarary/auth/login";
        options.LogoutPath = "/api/libarary/auth/logout";
        options.AccessDeniedPath = "/api/libarary/auth/denied";
